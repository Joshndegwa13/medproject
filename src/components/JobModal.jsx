          ...
          <div className="fixed inset-0 z-50 overflow-y-auto">
            <div className="flex min-h-full items-center justify-center p-4">
              <motion.div
                ...
                className="relative w-full max-w-2xl bg-white rounded-2xl shadow-2xl p-6 mx-auto my-8"
              >
                <button
                  onClick={onClose}
                  ...
                  {showSuccess ? (
                    ...
                    >
                      <div>
                        ...
                        <p className="text-xl text-primary-600">{job.companyName}</p>
                      </div>
                      ...
                      <div className="flex justify-end gap-4 pt-4">
                        ...
                        {user?.userType === 'job_seeker' && (
                          <motion.button
                            ...
                            whileHover={{ scale: 1.02 }}
                            whileTap={{ scale: 0.98 }}
                            className="px-6 py-2.5 rounded-lg bg-primary-600 text-white hover:bg-primary-700 transition-colors disabled:opacity-50"
                          >
